...
if __name__ == "__main__":
    ...
    # The dataset to use
    DATA_PATH = "JasperV13/Darija_Dataset"
    
    # Model paths
    MODEL_PATHS = {
                    "Llama-7B" : "sambanovasystems/SambaLingo-Arabic-Base", # default trained
    ...
    print("=" * 80)
    dataset = clean_dataset(dataset, TRAIN_ON_ARABIC_LETTERS_ONLY, TRAIN_ON_ARABIZI_ONLY)
